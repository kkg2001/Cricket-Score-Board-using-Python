...
def economy():
    economy1=int(bowling_runs_entry.get)/int(bowling_overs_entry.get)

    



mainPanel=Canvas(root,width=200,height=200)
#Batting
...
bowling_dot_balls.focus_force()
# bowling_dot_balls_entry.config(validate="key",validatecommand=(root.register(callback),'%P'))
# bowling_dot_balls_entry.grid(row=11,column=1,padx=5,pady=5)
